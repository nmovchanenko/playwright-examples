...
test.describe('add to cart scenarios', () => {
  ...
  test('<C235223> buy now from carousel using pom', async ({ page }) => {
    const pom = new MainPage(page);
  ...
  test('<C135221> add to cart from search using pom', async ({ page }) => {
    const pom = new MainPage(page);
  ...
  test('<C98452> add to cart from all products page using pom', async ({ page }) => {
    const pom = new MainPage(page);
    const product = 'Xbox Wireless Controller Mineral Camo Special Edition'
  ...
  test('<C99211> add to cart from all laptops page using pom', async ({ page }) => {
    const pom = new MainPage(page);
